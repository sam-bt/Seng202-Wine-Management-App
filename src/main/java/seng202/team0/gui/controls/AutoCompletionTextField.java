 ...
 * <p>
 * Modified from: <a href="https://stackoverflow.com/questions/36861056/javafx-textfield-auto-suggestions">...</a>
 */
public class AutoCompletionTextField extends TextField {
    ...
    private void populatePopup(List<String> searchResult) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            entryLabel.setPrefWidth(getWidth() - 10);  // Adjust to match TextField width, leaving some padding
