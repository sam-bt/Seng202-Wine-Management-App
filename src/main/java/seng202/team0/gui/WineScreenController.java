...
public class WineScreenController extends Controller {
  ...
  public void onApplyFiltersButtonPressed() {
    ...
    // Winery
    if (wineryChoiceBox.getValue() != null) {
      filters.put("winery", wineryChoiceBox.getValue());
    }

    // Country
    if (countryChoiceBox.getValue() != null) {
      filters.put("country", countryChoiceBox.getValue());
    }
