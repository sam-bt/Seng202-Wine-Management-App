...
public class WineScreenController extends Controller{
  ...
  public void onChildContextPopped(Object obj) {
    ...
    @FXML public void openHomeScreen() {
        TabChangerService.onHome(winoManager);
    }
  @FXML public void openListScreen() {
    TabChangerService.onLists(winoManager);
  }
  ...
  @FXML public void openConsumptionCalculatorScreen() {
    TabChangerService.onConsumption(winoManager);
  }
